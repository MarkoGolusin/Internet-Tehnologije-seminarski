...
<b>Spisak Predstava</b></br> 
</br> 
<form action="" method="GET">
ID Predstave: <input type="text" name="filter" />
...
if ($PredstavaViewObject->BrojZapisa==0)
...
else
	{
		...
		echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">&nbsp;IDPredstave&nbsp;</font></b><br/>";
		echo "</td>";
		echo "<td style=\"width:20%;\">";
		echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">&nbsp;Naziv&nbsp;</font></b><br/>";
		echo "</td>";
		echo "<td style=\"width:20%;\">";
		echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">&nbsp;Opis&nbsp;</font></b><br/>";
		echo "</td>";
		echo "<td style=\"width:20%;\">";
		echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">&nbsp;Naziv Zanra&nbsp;</font></b><br/>";
		echo "</td>";
		...
		echo "<tr>";
		echo "<td>";
		echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">$IDPredstave</font><br/>";
		echo "</td>";
		echo "<td>";
		echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">$Naziv</font><br/>";
		echo "</td>";
		echo "<td>";
		echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">$Opis</font><br/>";
		echo "</td>";
		echo "<td>";
		echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">$NazivZanra</font><br/>";
		echo "</td>";
		echo "<td>";
		echo "<form ACTION=\"PredstavaIzmeniForm.php\" METHOD=\"POST\">";
		echo "<input type=\"hidden\" name=\"IDPredstave\" value=\"$IDPredstave\">";
		echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\"><input TYPE=\"submit\" name=\"izmeniPredstavaa\" value=\"IZMENI\" /></font></b>";
		echo "</form>";
		echo "</td>";
echo "<td>";
echo "<form action=\"klase/PredstavaController.php\" method=\"POST\">";
echo "<input type=\"hidden\" name=\"IDPredstave\" value=\"$IDPredstave\">";
echo "<input type=\"hidden\" name=\"akcija\" value=\"obrisi\">"; // controller zna koju akciju da izvrši
echo "<font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">
        <input type=\"submit\" name=\"obrisiPredstava\" value=\"OBRISI\" 
        onclick=\"return confirm('Da li ste sigurni da zelite da obrisete zapis?')\"/>
      </font>";
echo "</form>";
echo "</td>";
		echo "</tr>";
		...
		echo "</td>";
		echo "<td align=\"right\">";
		echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\">УКУПНO:".$PredstavaViewObject->BrojZapisa."&nbsp;&nbsp;</font><br/>";
		echo "</td>";
		echo "<td align=\"right\">";
		echo "</td>";
		echo "<td style=\"width:20%;\">";
